...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_fragment_three,
                container, false);

        ArrayList<String> setOfString = getSharedPreferencesArrayList("PeersMatched");
        String[] aux = new String[setOfString.size()];
        aux = setOfString.toArray(aux);
        //update the listview
        saveListView = (ListView) rootView.findViewById(R.id.PeersListView);
